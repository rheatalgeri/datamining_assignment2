...
df = pd.read_csv('C:\\Users\\rheat\\Desktop\\IT_Learning\\Masters\\data_mining\\assignments\\assignment_2\\datasets\\movies\\u.data')
import pandas as pd

# Load the .data file as a pandas dataframe
data = pd.read_csv('C:\\Users\\rheat\\Desktop\\IT_Learning\\Masters\\data_mining\\assignments\\assignment_2\\datasets\\movies\\u.data', header=None, delimiter=',')

# Count the number of unique items
unique_items = len(data.values.flatten().tolist())
